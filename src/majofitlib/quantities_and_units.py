...
quantity_unit_register("charge", "C", multiplier=1, unicode_name="C")


quantity_unit_register("magnetic field", "T", multiplier=1, unicode_name="T")
...
quantity_unit_register("mobility", "cm^2/(V*s)", multiplier=1E-4,unicode_name="cm²/(V·s)")